...
test('quit waits for the owned runtime before destroying windows; recursive quit does not stop twice', async () => {
  ...
  const context = {
    shuttingDown: false, appExitCode: 0, backups: null, clearInterval:()=>{}, optimizerTimer:0, optimizer:null, quitting: false, tray: null,
...
test('cleanup failures never skip the runtime or remaining windows', async () => {
  ...
  const context = {
    shuttingDown: false, appExitCode: 0, backups: null, clearInterval:()=>{}, optimizerTimer:0, optimizer:null, quitting: false, tray: null, console: { error: (...args) => errors.push(args) },
