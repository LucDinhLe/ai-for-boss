...
[Tải bộ cài Windows beta39](https://github.com/LucDinhLe/ai-for-boss/releases/download/0.0.5-beta.39/AI-for-Boss-0.0.5-beta.39-Setup.exe) · [Ghi chú và mã SHA256](https://github.com/LucDinhLe/ai-for-boss/releases/tag/0.0.5-beta.39) · [Bản trước beta38](https://github.com/LucDinhLe/ai-for-boss/releases/tag/0.0.5-beta.38).

## Cài và dùng thử

1. Tải `AI-for-Boss-0.0.5-beta.39-Setup.exe`, đối chiếu SHA256 trong cùng release rồi chạy bộ cài.
...
- Từ beta37, mỗi lượt gửi có ba nút chế độ Nhanh, Kỹ, Quyết định quan trọng đặt trần bước công cụ và mức suy nghĩ; trợ lý dừng và hỏi khi chạm trần thay vì chạy tới hết hạn mức. Điều anh chị chốt được ghi vào sổ `QUYET-DINH.md` trong thư mục làm việc và được đọc lại ở lượt sau.
- Mười hai kỹ năng doanh nghiệp tiếng Việt đi kèm (mục tiêu quý, rà soát tuần, kế hoạch dự án, theo dõi tiến độ, biên bản họp, hồ sơ khách tiềm năng, đề xuất báo giá, theo dõi sau gặp, kế hoạch chiến dịch, lịch nội dung tuần, viết bài giữ giọng, quy tắc điều hành) và bốn mẫu agent theo vai. Kỹ năng là văn bản hướng dẫn mô hình, chưa qua bộ eval; số liệu vẫn chỉ đến từ anh chị.
...
**Trạng thái hiện tại:** beta39 là bản thử nghiệm. Tài liệu quản trị mô tả mục tiêu sản phẩm; không capability nào đang được quảng cáo là production-ready. Các mốc Cổng 0/Feature 0.x trong lịch sử không phải số phiên bản bộ cài.
