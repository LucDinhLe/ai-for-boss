...
[Tải bộ cài Windows beta44](https://github.com/LucDinhLe/ai-for-boss/releases/download/0.0.5-beta.44/AI-for-Boss-0.0.5-beta.44-Setup.exe) · [Ghi chú và mã SHA256](https://github.com/LucDinhLe/ai-for-boss/releases/tag/0.0.5-beta.44) · [Bản trước beta43](https://github.com/LucDinhLe/ai-for-boss/releases/tag/0.0.5-beta.43).

## Cài và dùng thử

1. Tải `AI-for-Boss-0.0.5-beta.44-Setup.exe`, đối chiếu SHA256 trong cùng release rồi chạy bộ cài.
