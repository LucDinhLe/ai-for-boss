...
export const CHROME = {
  ...
  detected: "Kết nối và mô hình tìm thấy",
  detectedHint: "Chọn để kiểm tra và kích hoạt kết nối. Tên xuất hiện ở đây chưa thay cho kết quả kiểm tra thực tế.",
  allProviders: "Kết nối bằng API key hoặc token",
