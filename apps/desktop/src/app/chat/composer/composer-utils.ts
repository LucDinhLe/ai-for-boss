 ...
 * (Salvaged from upstream Hermes desktop into Hermes Vietnamese 2026.9.5: the
 * old rule locked the editor during `connecting`, so every reconnect attempt
 * flipped contentEditable off and dropped focus.)
 */
