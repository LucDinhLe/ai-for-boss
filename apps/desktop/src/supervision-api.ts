...
export type SupervisionState = { id: string; key: string; phase: string; busy: boolean; accepted: boolean; modelActive?: boolean;
  plan: string; consultation?: string; planAttempt?: number; workAttempt?: number; reviewCalls?: number; warning?: string | null; planReview: AdvisorResult | null; finalReview: AdvisorResult | null; error: string | null };
