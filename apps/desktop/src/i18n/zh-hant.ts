...
export const zhHant = defineLocale({
  ...
  boot: {
    ready: 'AI for Boss 已就緒',
    desktopBootFailedWithMessage: message => `桌面啟動失敗：${message}`,
    steps: {
      connectingGateway: '正在連線桌面閘道',
      loadingSettings: '正在載入 AI for Boss 設定',
      loadingSessions: '正在載入最近工作階段',
      retryingRemoteBackend: '正在重新連線遠端 AI for Boss 後端…',
      startingDesktopConnection: '正在啟動桌面連線',
      startingHermesDesktop: '正在啟動 AI for Boss…'
    },
    errors: {
      backgroundExited: 'AI for Boss 背景程序已結束。',
      backgroundExitedDuringStartup: 'AI for Boss 背景程序在啟動期間結束。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '您的 AI for Boss 後端早於目前的桌面版本，可能無法正常運作。請更新以保持一致。',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 AI for Boss。',
    ...
    native: {
      ...
      rejectAction: '拒絕',
      inputTitle: '需要輸入',
      inputBody: 'AI for Boss 正在等待你的回應。',
  ...
  settings: {
    ...
    resetConfirm: '要將所有設定恢復為 AI for Boss 預設值嗎？',
    exportFailed: '匯出失敗',
    resetFailed: '重設失敗',
    nav: {
      providers: '提供方',
    ...
    notifications: {
      ...
      focusedHint: '完成提醒僅在 AI for Boss 位於背景時觸發。',
      kinds: {
        approval: {
          label: '需要核准',
        ...
        input: {
          label: '需要輸入',
          description: 'AI for Boss 提出了問題，或需要密碼或密鑰。'
        },
        turnDone: {
          label: '回覆就緒',
          description: 'AI for Boss 在背景時完成了一輪對話。'
        },
        turnError: {
          label: '本輪失敗',
          description: '背景回合錯誤。'
        ...
        plugin: {
          label: '外掛通知',
          description: 'AI for Boss 在背景時，桌面外掛傳送了通知。'
        }
      },
      test: '傳送測試通知',
    ...
    appearance: {
      ...
      colorMode: '色彩模式',
      colorModeDesc: '選擇固定模式，或讓 AI for Boss 跟隨系統設定。',
      ...
      reactionsTitle: '訊息回應',
      reactionsDesc: 'iMessage 風格的表情回應 — 你可以對訊息做出回應，AI for Boss 也能回應你的訊息。',
      ...
      pet: {
        title: '寵物',
        intro:
          '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 AI for Boss 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
        restartHint: '寵物功能需要重新啟動——目前執行的應用在此功能加入前啟動。請結束並重新開啟 AI for Boss，然後回到此處。',
        scaleTitle: '大小',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'AI for Boss 需要本機時間上下文時使用。留空則使用系統時區。',
      agent: {
        imageInputMode: '控制圖片附件如何傳送給模型。',
        maxTurns: 'AI for Boss 停止一次執行前的工具呼叫輪次上限。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'AI for Boss 單次檔案讀取可讀取的最大字元數。',
      approvals: {
        mode: 'AI for Boss 如何處理需要明確批准的指令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'AI for Boss 從應用程式內更新自身時，保留本機原始碼變更（stash）或丟棄（discard）。終端機更新一律會詢問。'
      }
    }),
    about: {
      heading: 'AI for Boss',
      ...
      license: '授權條款',
      licenseValue: 'MIT 授權條款',
      communityUpdateChannel: 'AI for Boss 頻道 · GitHub Releases',
      bundleOutOfSync: '應用程式建置版本過舊',
      bundleOutOfSyncDesc:
        'AI for Boss 執行環境已更新,但桌面應用程式本身仍是舊建置——在應用程式更新之前,新的介面功能(如 Agents)不會顯示。請執行下方的更新以重新建置應用程式。如果此警告仍未消除,請從最新的桌面安裝程式重新安裝。',
      ...
      notifyOnlyDesc: 'AI for Boss 只會提醒新版本，不會自行下載或安裝；請從 GitHub Releases 下載安裝檔並核對校驗值。',
      checksumLine: (filename, sizeMb, sha256) => `${filename} · ${sizeMb} MB · SHA-256 ${sha256}`,
      lastChecked: age => `上次檢查：${age}`,
      justNowSuffix: ' · 剛剛',
      automaticUpdates: '自動更新',
      automaticUpdatesDesc: 'AI for Boss 會在背景自動檢查更新，並在有可用更新時通知你。',
    ...
    quickEntry: {
      enabledTitle: '快速輸入',
      enabledDesc: '用全域快速鍵在任何地方喚出一個小輸入框，無需開啟 AI for Boss 即可送出提示。',
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'AI for Boss 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 AI for Boss 後端，請使用遠端閘道。閘道連線屬於本機層級設定；設定檔是從已連線的閘道中探索出來的。',
      ...
      localTitle: '本機閘道',
      localDesc: '在 localhost 啟動私有 AI for Boss 後端。這是預設方式，可離線使用。',
      remoteTitle: '遠端閘道',
      remoteDesc:
        '將此桌面殼層連線至遠端 AI for Boss 後端。託管閘道使用 OAuth 或帳號密碼；自託管閘道也可使用工作階段 Token。',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'AI for Boss 將使用已儲存的設定重新連線。',
      ...
      sshTitle: '透過 SSH 連線',
      sshDesc:
        'AI for Boss 會透過 SSH 在遠端啟動並以通道連線到本應用程式——無需自行啟動或公開任何服務。前提：已具備到該主機的金鑰 SSH 存取。',
      ...
      sshHermesPathTitle: 'AI for Boss 路徑（選用）',
      ...
      sshReachable: (host, platform) => `可連線：${host}（${platform}）——已找到 AI for Boss`,
      sshIncompleteHost: '連線前請輸入 SSH 主機。',
      sshErrUnreachable: '無法透過 SSH 連線到該主機。請檢查主機、連接埠和網路。',
      sshErrAuth:
        'SSH 驗證失敗。請將金鑰載入 ssh-agent（ssh-add），或在 ~/.ssh/config 中設定 IdentityFile——AI for Boss 以非互動方式執行 ssh。',
      ...
      sshErrPlatform: '不支援的遠端平台。AI for Boss 的 SSH 模式支援 Linux、macOS 和 Windows 遠端主機。',
      sshErrTimeout: 'SSH 連線逾時。主機可能無法存取或處於睡眠狀態。',
      sshErrUpdateRequired: '使用 Desktop SSH 連線前，請更新遠端主機上的 AI for Boss。',
    ...
    mcp: {
      ...
      deepLinkDescription: '一個連結要求將此 MCP 伺服器加入 AI for Boss。請檢查下方的完整設定——它來自該連結，而非 AI for Boss。',
    ...
    model: {
      ...
      model: '模型',
      applying: '套用中...',
      advisorTitle: '監督模型（Advisor）',
      advisorDesc: '獨立模型會在 AI for Boss 回覆前檢查計畫、重大調整或重複錯誤，以及最終結果。',
      advisorEnabled: '啟用監督模型',
      advisorCost: '啟用後，每個檢查點都會增加一次模型呼叫、延遲與費用。',
      advisorModel: '監督模型',
      auxiliaryTitle: '輔助模型',
    ...
    providers: {
      ...
      intro: '使用訂閱登入，無需複製 API 金鑰。AI for Boss 會在應用程式中為您完成瀏覽器登入。',
      connected: '已連線',
      collapse: '收合',
      ...
      localEndpoint: {
        title: '本地 / 自訂端點',
        description: '將 AI for Boss 指向任意 OpenAI 相容端點（Zyphra、vLLM、llama.cpp、Ollama 等）。'
      },
      loading: '正在載入提供方...'
    },
    sessions: {
  ...
  starmap: {
    ...
    loading: '載入中…',
    emptyTitle: '尚無學習內容',
    emptyDesc: '當 AI for Boss 為你的工作建立技能與記憶時，會顯示在這裡。'
  },
  agents: {
    close: '關閉代理',
    title: '派生樹',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: '請重新啟動 AI for Boss 以使用寵物功能。',
      empty: '沒有符合的寵物。',
      turnOff: '關閉',
      turnOn: '開啟',
      installed: '已安裝',
    ...
    generatePet: {
      ...
      staleBackend: '請更新 AI for Boss 以生成寵物。',
      backgroundHint: '你可以關閉此視窗——完成後 AI for Boss 會通知你。',
    ...
    nav: {
      ...
      settings: { title: '設定', detail: '設定 AI for Boss 桌面端' },
    ...
    hermesActiveSessions: (version, count) => `AI for Boss ${version} · 活躍工作階段 ${count}`,
  ...
  profiles: {
    ...
    deleting: '刪除中…',
    createDesc: '設定檔是獨立的 AI for Boss 環境：各自擁有獨立的設定、技能和 SOUL.md。',
    nameLabel: '名稱',
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      review: '檢查排程工作',
      saveFailed: 'AI for Boss 未儲存該模型變更。'
    },
    search: '搜尋排程工作…',
    loading: '正在載入排程工作…',
    states: {
    ...
    newCron: '新排程工作',
    emptyDescNew: '按 cron 表達式排程一個提示詞。AI for Boss 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaHint: '選填。建立專案時，AI for Boss 會將此內容儲存為主要資料夾中的 IDEA.md，讓代理了解目標。',
      ...
      createFailed: '無法建立專案',
      staleBackend: '請更新 AI for Boss 後端以建立專案——目前後端比桌面應用舊（設定 → 更新 → 後端）。',
      deleteConfirm: '這會從 AI for Boss 中移除已儲存的專案。工作階段、檔案、git 儲存庫和工作樹維持不變。',
      startWork: '新增工作樹',
      ...
      worktreeStaleBackend: '請更新 AI for Boss 後端以在此遠端連線上建立工作樹 —— 該後端早於 git 工作樹 API。',
      ...
      back: count => (count > 0 ? `所有專案 · 還有 ${count} 個其他工作階段` : '所有專案')
    },
  ...
  composer: {
    ...
    placeholderStarting: '正在啟動 AI for Boss...',
    placeholderReconnecting: '正在重新連線至 AI for Boss…',
    ...
    attachUrlDesc: 'AI for Boss 將擷取該頁面並作為此回合的脈絡。',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: '讓 AI for Boss 提交並開 PR',
  ...
  updates: {
    ...
    unsupportedMessage: '此版本的 AI for Boss 無法在應用程式內自行更新。',
    connectionRetry: '請檢查網路連線後重試。',
    latestBody: '您正在執行最新版本。',
    latestBodyBackend: '後端正在執行最新版本。',
    allSetTitle: '已是最新版本',
    availableTitle: '有可用更新',
    availableBody: '新版 AI for Boss 已可安裝。',
    availableTitleBackend: '後端有可用更新',
    availableBodyBackend: '已連接的 AI for Boss 後端有新版本可安裝。',
    availableBodyNoChangelog: '已有新版本可用。此安裝方式無法顯示更新日誌。',
    updateNow: '立即更新',
    maybeLater: '稍後再說',
    moreChanges: count => `另有 ${count} 項變更。`,
    manualTitle: '從終端機更新',
    manualBody: '您是從命令列安裝的 AI for Boss，因此更新也需要在那裡執行。請將此指令貼到終端機：',
    manualPickedUp: '下次啟動 AI for Boss 時會使用新版本。',
    guiSkewTitle: '請更新桌面應用程式',
    guiSkewBody:
      '後端已更新，但此桌面應用程式套件未變更。請更新或重新安裝 AI for Boss 桌面應用程式（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '複製',
    copied: '已複製',
    done: '完成',
    applyingBody:
      'AI for Boss 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 AI for Boss。更新期間請勿自行重新開啟 AI for Boss。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 AI for Boss 會自動重新連線。',
    applyingClose: '此視窗會在更新期間關閉，隨後 AI for Boss 會自動重新開啟。',
    errorTitle: '更新未完成',
    errorBody: '沒有資料遺失。您可以現在重試。',
    blockerTitle: '關閉本機預覽以更新 AI for Boss？',
    blockerBody: 'AI for Boss 需要在更新前停止這些本機預覽。這不會修改或刪除您的檔案。',
    foreignBlockerTitle: '關閉其他處理程序以更新 AI for Boss',
    foreignBlockerBody:
      'AI for Boss 無法安全地自動關閉這些處理程序。請關閉擁有這些處理程序的應用程式、終端機或服務，然後重試更新。',
    mixedBlockerBody: 'AI for Boss 可以關閉下方列出的本機預覽。其他處理程序必須手動關閉，更新才能繼續。',
  ...
  install: {
    ...
    oneTimeTitle: 'AI for Boss 需要一次性安裝',
    ...
    setupChoiceTitle: '設定 AI for Boss',
    setupChoiceDesc: '將此應用程式連線到您已執行的 AI for Boss 閘道，或在這台電腦上本機安裝 AI for Boss。',
    connectExistingTitle: '連線到現有 AI for Boss',
    connectExistingShort: '連線現有環境',
    connectExistingDesc: '使用工作階段權杖或瀏覽器登入連線遠端後端。不會啟動本機安裝。',
    installLocalTitle: '本機安裝 AI for Boss',
    installLocalDesc: '下載 AI for Boss、建立 Python 環境，並在這台電腦上執行後端。',
    localStartUnavailable: '無法啟動本機安裝。請重新啟動 AI for Boss 後再試一次。',
    remoteSetupTitle: '連線到現有 AI for Boss',
    remoteSetupDesc: '輸入閘道 URL。AI for Boss 會偵測需要權杖還是瀏覽器登入。',
    remoteUrlTitle: '閘道 URL',
    remoteUrlDesc: '使用 Hermes 閘道的基礎 URL；遠端位址請包含 https://。',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: '正在偵測閘道驗證方式...',
    probeError: '無法連線到該 AI for Boss 閘道。',
    ...
    backToSetup: '返回',
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 AI for Boss',
    finishingTitle: '正在收尾',
    failedDesc:
      '某個安裝步驟失敗。在 Windows 上，如果另一個 AI for Boss CLI 或桌面執行個體正在執行，可能會出現這種情況。請停止正在執行的 AI for Boss 執行個體後重試。可查看下方的詳細資訊或 desktop 記錄中的完整記錄。',
    activeDesc: '這是一次性設定。AI for Boss 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    workProfile: {
      title: '設定您的工作',
      description: '選擇工作領域，AI for Boss 會從本機目錄建議少量已安裝的 Skill。',
      areasLabel: '工作領域',
      areas: {
        research_learning: '研究與學習',
        leadership_business: '領導與商業',
    ...
    headerTitle: '開始設定 AI for Boss',
    headerDesc: '連線模型提供方即可開始聊天。大多數選項只需一次點擊。',
    preparingInstall: 'AI for Boss 正在完成安裝。首次執行通常不到一分鐘。',
    starting: '正在啟動 AI for Boss…',
    ...
    recommended: '建議',
    connected: '已連線',
    featuredPitch: '一個訂閱，300+ 前沿模型 — 執行 AI for Boss 的建議方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自託管',
        description: '將 AI for Boss 指向本機或自託管的 OpenAI 相容端點（vLLM、llama.cpp、Ollama 等）。'
      }
    },
    backToSignIn: '返回登入',
    getKey: '取得金鑰',
    ...
    flowSubtitles: {
      ...
      device_code: '在瀏覽器中開啟驗證頁面 — AI for Boss 會自動連線',
    ...
    authorizeThere: '請在那裡授權 AI for Boss。',
    copyAuthCode: '複製授權碼並貼到下方。',
    pasteAuthCode: '貼上授權碼',
    reopenAuthPage: '重新開啟授權頁面',
    autoBrowser: provider => `已在瀏覽器中開啟 ${provider}。請在那裡授權 AI for Boss，連線會自動完成，無需複製或貼上。`,
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      restartGateway: '重新啟動',
      stopGateway: '停止',
      forceStopGateway: '強制停止',
      forceStopUnavailable: '此閘道來源不支援強制停止。',
      viewLogs: '查看記錄',
      runDoctor: '執行診斷',
      checkHealth: '檢查健康狀態',
      stopConfirmTitle: '停止此閘道？',
      stopConfirmBody: profile => `設定檔「${profile}」的使用中工作階段可能會中斷。聊天與設定將保留。`,
      stopSharedConfirmBody: '此共享閘道服務多個設定檔。使用中工作階段可能會中斷。聊天與設定將保留。',
      actionFailed: action => `${action}失敗。`,
      actionTimedOut: '動作仍在執行，但等待已逾時。請先檢查狀態，再重試。',
      lifecycleManagedBy: profile => `此閘道為共享閘道，只能從設定檔「${profile}」控制其生命週期。`,
      lifecycleOwnerUnknown: '後端無法確認閘道歸屬，因此生命週期控制不可用。',
      sharedLifecycleWarning: '此閘道由多個設定檔共享。重新啟動或停止會影響所有正在服務的設定檔。',
      statusLoadFailed: '無法載入閘道狀態。',
      logsEmpty: '尚無閘道記錄。',
      logsLoadFailed: '無法載入閘道記錄。',
      doctorStarted: '診斷已開始。',
      healthHealthy: '閘道運作正常。',
      healthUnhealthy: '閘道健康檢查失敗。',
      openSystem: '開啟系統面板',
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        compactAt: (tokens, percent) => `AI for Boss 將在 ${tokens} 時壓縮（目前路由的 ${percent}%）`,
        compactNow: '已達到壓縮門檻',
        costActual: amount => `供應商回報的工作階段費用：${amount} USD`,
        costDisclaimer: '依公開 API 價格估算；工具、區域和合約費用可能不同。',
        costEstimated: amount => `工作階段預估費用：${amount} USD`,
        costIncluded: '已包含在目前訂閱中',
        costReference: amount => `API 等值參考：${amount} USD`,
        costTitle: '工作階段費用',
        costTokens: (input, output, cache) => `${input} 輸入 · ${output} 輸出 · ${cache} 快取`,
        costUnknown: '此路由尚無公開價格',
        effectiveCapacity: tokens => `目前路由限制：${tokens}`,
        empty: '尚無上下文資料',
        estimated: '估算值',
        loading: '正在載入明細…',
        measured: '實測值',
        ...
        remaining: tokens => `官方視窗剩餘：${tokens}`,
        sourceAnthropic: 'Anthropic',
        sourceOpenAI: 'OpenAI',
        sourceRuntime: '目前路由',
        title: '上下文使用量',
        tokenSummary: (used, max) => `${used} / ${max} Tokens`,
        tokensUntilCompact: tokens => `距離 AI for Boss 壓縮還有 ${tokens}`,
  ...
  preview: {
    ...
    largeTitle: '此檔案較大',
    largeBody: (label, size) => `${label} 大小為 ${size}。AI for Boss 只會顯示前 512 KB。`,
    previewAnyway: '仍然預覽',
    ...
    web: {
      ...
      failedToLoad: '預覽載入失敗',
      tryAgain: '重試',
      restarting: 'AI for Boss 正在重新啟動...',
      askRestart: '請 AI for Boss 重新啟動伺服器',
      lookingRestart: taskId => `AI for Boss 正在尋找要重新啟動的預覽伺服器 (${taskId})`,
      restartingTitle: '正在重新啟動預覽伺服器',
      restartingMessage: 'AI for Boss 正在背景執行。可在預覽主控台查看進度。',
      ...
      finishedRestarting: message => `AI for Boss 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      failedRestarting: message => `伺服器重新啟動失敗：${message}`,
      unknownError: '未知錯誤',
      restartedTitle: '預覽伺服器已重新啟動',
      reloadingNow: '正在重新載入預覽。',
      restartFailedTitle: '預覽重新啟動失敗',
      restartFailedMessage: 'AI for Boss 無法重新啟動伺服器。',
      stillWorking: 'AI for Boss 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
      ...
      fallbackTitle: '預覽',
      connector: {
        openButton: '使用 Chrome 或 Edge 工作階段',
        title: 'AI for Boss Connector',
        description: '透過官方 Chrome 或 Edge 擴充功能傳送目前網站的 Cookie。',
        loading: '正在檢查連接器…',
        officialExtension: '官方配套擴充功能',
        trustVerified: '已驗證套件摘要與權限政策。',
        trustFailed: '擴充功能驗證失敗。請保持連接器關閉。',
        openFolder: '開啟資料夾',
        extensionId: '擴充功能 ID',
        digest: 'SHA-256',
        enabled: '連接器已啟用',
        disabled: '連接器已關閉',
        enableDescription: '啟用後可進行短時間的本機配對；每個網站仍需你的確認。',
        enable: '啟用',
        disable: '關閉',
        currentSite: 'AI for Boss Browser 網站',
        createCode: '建立一次性代碼',
        pairingTitle: '配對瀏覽器擴充功能',
        pairingInstructions: '在 Chrome 或 Edge 的相同網站開啟 AI for Boss Connector，預覽 Cookie 後輸入此代碼。',
        copy: '複製',
        expiresAt: time => `${time} 到期`,
        previewReady: '匯入前檢查',
        browser: '瀏覽器',
        domain: '網域',
        cookies: '可匯入 Cookie',
        sessionCookies: '工作階段 Cookie',
        unsupported: '不支援',
        expiry: '最晚到期時間',
        sessionOnly: '工作階段關閉時',
        importWarning: '匯入可能取代 AI for Boss Browser 中識別相同的 Cookie。分割區 Cookie 會被略過。',
        confirmImport: (count, hostname) => `為 ${hostname} 匯入 ${count} 個 Cookie`,
        importing: '正在安全等待並匯入…',
        imported: (count, hostname) => `已為 ${hostname} 匯入 ${count} 個 Cookie。`,
        skippedUnsupported: count => `已略過 ${count} 個不支援的分割區 Cookie。`,
        importedSessions: '已匯入的網站工作階段',
        noImports: '尚無已匯入的網站工作階段。',
        importRecord: (count, time) => `${count} 個 Cookie · ${time}`,
        revoke: '刪除',
        revokeWarning: '刪除只會移除已記錄的 Cookie 識別。網站更新出的相同識別 Cookie 也會被刪除。',
        error: code => `連接器無法繼續（${code}）。Cookie 值未寫入記錄。`,
        close: '關閉'
      }
    }
  },
  ...
  assistant: {
    thread: {
      ...
      showEarlier: '顯示較早的訊息',
      loadingResponse: 'AI for Boss 正在載入回覆',
    ...
    approval: {
      gatewayDisconnected: 'AI for Boss 閘道未連線',
      sendFailed: '無法傳送核准回應',
      run: '執行',
      command: '指令',
      moreOptions: '更多核准選項',
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.hermes/config.yaml）。AI for Boss 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'AI for Boss 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
    sudoPlaceholder: 'sudo 密碼',
    secretTitle: '需要密鑰',
    secretDesc: 'AI for Boss 需要一個憑證才能繼續。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重新啟動 AI for Boss 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 AI for Boss 以儲存圖片',
