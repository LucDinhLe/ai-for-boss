...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'AI for Boss 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Hermes 後端，請使用遠端閘道。閘道連線屬於本機層級設定；設定檔是從已連線的閘道中探索出來的。',
    ...
    model: {
      ...
      advisorDesc: '獨立模型會在 Hermes 回覆前檢查計畫、重大調整或重複錯誤，以及最終結果。',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: '這會從 Hermes 中移除已儲存的專案。工作階段、檔案、git 儲存庫和工作樹維持不變。',
      startWork: '新增工作樹',
  ...
  shell: {
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        compactAt: (tokens, percent) => `Hermes 將在 ${tokens} 時壓縮（目前路由的 ${percent}%）`,
        compactNow: '已達到壓縮門檻',
  ...
  preview: {
    ...
    web: {
      ...
      connector: {
        ...
        enable: '啟用',
        disable: '關閉',
        currentSite: 'Hermes Browser 網站',
        createCode: '建立一次性代碼',
        pairingTitle: '配對瀏覽器擴充功能',
        pairingInstructions: '在 Chrome 或 Edge 的相同網站開啟 Hermes Connector，預覽 Cookie 後輸入此代碼。',
        copy: '複製',
        ...
        expiry: '最晚到期時間',
        sessionOnly: '工作階段關閉時',
        importWarning: '匯入可能取代 Hermes Browser 中識別相同的 Cookie。分割區 Cookie 會被略過。',
