...
export const en: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaHint:
        'Optional. When you create the project, Hermes saves this as IDEA.md in the primary folder so agents can understand the goal.',
      ...
      deleteConfirm:
        'This removes the saved project from Hermes. Sessions, files, git repos, and worktrees stay untouched.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        compactAt: (tokens, percent) => `Hermes compacts at ${tokens} (${percent}% of the current route)`,
  ...
  preview: {
    ...
    web: {
      ...
      connector: {
        ...
        enable: 'Enable',
        disable: 'Disable',
        currentSite: 'Hermes Browser website',
        createCode: 'Create one-time code',
        pairingTitle: 'Pair the browser extension',
        pairingInstructions:
          'Open Hermes Connector on the same website in Chrome or Edge, preview cookies, then enter this code.',
        copy: 'Copy',
        ...
        importWarning:
          'Import can replace cookies with the same identity in Hermes Browser. Partitioned cookies are skipped.',
  ...
  assistant: {
    thread: {
      ...
      workProgress: {
        ...
        advisorRevisionReason: 'Hermes will refine the affected step before continuing.',
        advisorUnavailableAction: 'Advisor is unavailable',
        advisorUnavailableReason: 'Hermes will follow the configured availability policy for this session.',
        ...
        advisorUnresolvedReason: 'Hermes will report the remaining gap instead of claiming unsupported completion.'
      }
    },
    approval: {
