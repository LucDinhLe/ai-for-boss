...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'Loading AI for Boss settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote AI for Boss backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting AI for Boss…'
    },
    errors: {
      backgroundExited: 'AI for Boss background process exited.',
      backgroundExitedDuringStartup: 'AI for Boss background process exited during startup.',
    ...
    failure: {
      title: "AI for Boss couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your AI for Boss backend is older than this desktop build and may not work correctly. Update to align them.',
    backendOutOfDateBundledMessage:
      'The AI for Boss service bundled with this app does not match this desktop build. Install the latest AI for Boss release to fix it; updating the service in place is not supported.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update AI for Boss',
    ...
    native: {
      ...
      inputBody: 'AI for Boss is waiting for your response.',
      turnDoneTitle: 'AI for Boss finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to AI for Boss defaults?',
    ...
    workProfile: {
      title: 'Work profile',
      intro: 'Choose how you work. AI for Boss keeps only the Skills you approve available to new sessions.',
    ...
    plugins: {
      ...
      disable: 'Disable',
      required: 'required',
      requiredDescription: 'This bundled AI for Boss feature is required and stays enabled.',
      failed: 'failed',
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the AI for Boss backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the AI for Boss backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while AI for Boss is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'AI for Boss asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while AI for Boss was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while AI for Boss was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let AI for Boss follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and AI for Boss can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what AI for Boss is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen AI for Boss, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The AI for Boss runtime was updated, but the desktop app itself is still an older build — new interface features (like Agents) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'AI for Boss checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading AI for Boss configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening AI for Boss.',
      ...
      window: {
        ...
        placeholder: 'Ask AI for Boss…',
        disconnectedPlaceholder: 'Not connected — open AI for Boss to reconnect',
        sendTo: 'Send to',
    ...
    connections: {
      ...
      kindSsh: 'SSH',
      kindLocalDesc: 'The AI for Boss runtime managed by this app.',
      kindRemoteDesc: 'A AI for Boss gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Hermes Cloud account.',
      kindSshDesc: 'A AI for Boss install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers AI for Boss manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a AI for Boss backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private AI for Boss backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote AI for Boss backend.',
      ...
      sshDesc:
        'AI for Boss is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'AI for Boss path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — AI for Boss found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — AI for Boss runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update AI for Boss on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to AI for Boss. Review the exact configuration below — it comes from the link, not from AI for Boss.',
    ...
    model: {
      ...
      advisorDesc:
        'An independent model reviews the plan, major recovery changes, and the final result before AI for Boss replies.',
    ...
    providers: {
      ...
      googleAccount: {
        ...
        tierLabel: 'Tier',
        caveat:
          'This uses the same door as Gemini CLI. Google may change or close it; it is not an official AI for Boss provider.',
      ...
      intro:
        'Sign in with a subscription — no API key to copy. AI for Boss runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point AI for Boss at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    defaultProfile: 'AI for Boss (default)',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As AI for Boss builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart AI for Boss to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update AI for Boss to generate pets.',
      backgroundHint: 'You can close this — AI for Boss will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure AI for Boss desktop' },
    ...
    hermesActiveSessions: (version, count) => `AI for Boss ${version} · Active sessions ${count}`,
    ...
    maintenance: {
      ...
      importBackupDesc: 'Select a AI for Boss backup zip and restore its config, memories, skills, and sessions',
      importBackupConfirm:
        'Restore this backup? Existing AI for Boss data with the same names will be replaced. The current installation and app files will stay in place.',
      importBackupRestart: 'Restore completed. Restart AI for Boss to load all restored data.',
  ...
  profiles: {
    ...
    connectGateway: 'Connect another AI for Boss gateway…',
    actions: 'Actions',
    color: 'Color…',
    colorFor: 'Color',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent AI for Boss environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'AI for Boss did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. AI for Boss will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      manageDescription: 'Keep related folders, sessions, and usage together.',
      ...
      ideaLabel: 'Idea',
      ideaPlaceholder: "Describe the project's goal and main idea.",
      ideaHint:
        'Optional. When you create the project, AI for Boss saves this as IDEA.md in the primary folder so agents can understand the goal.',
      ideaSaveFailed: 'The project was created, but IDEA.md could not be saved in the primary folder.',
      ...
      staleBackend:
        'Update the AI for Boss backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm:
        'This removes the saved project from AI for Boss. Sessions, files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the AI for Boss backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting AI for Boss...',
    placeholderReconnecting: 'Reconnecting to AI for Boss…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give AI for Boss a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'AI for Boss will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask AI for Boss to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating AI for Boss…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting AI for Boss…',
    ...
    unsupportedMessage: 'This version of AI for Boss can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of AI for Boss is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected AI for Boss backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed AI for Boss from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'AI for Boss will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the AI for Boss desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The AI for Boss updater takes over in its own window and reopens AI for Boss automatically when it’s done. Please don’t reopen AI for Boss yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. AI for Boss reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then AI for Boss reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update AI for Boss?',
    blockerBody:
      'AI for Boss needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update AI for Boss',
    foreignBlockerBody:
      'AI for Boss can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'AI for Boss can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'AI for Boss needs a one-time install',
    ...
    setupChoiceDesc:
      'Connect this app to a AI for Boss gateway you already run, or install AI for Boss locally on this computer.',
    connectExistingTitle: 'Connect to existing AI for Boss',
    ...
    installLocalTitle: 'Install AI for Boss locally',
    installLocalDesc: 'Download AI for Boss, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart AI for Boss and try again.',
    remoteSetupTitle: 'Connect to existing AI for Boss',
    remoteSetupDesc:
    ...
    probeError: 'Could not reach that AI for Boss gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up AI for Boss',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another AI for Boss CLI or desktop instance is running. Stop any running AI for Boss instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The AI for Boss installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you set up with AI for Boss",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'AI for Boss is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting AI for Boss…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run AI for Boss',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point AI for Boss at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — AI for Boss connects automatically',
    ...
    authorizeThere: 'Authorize AI for Boss there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize AI for Boss there and you'll be connected automatically — nothing to copy or paste.`,
    ...
    workProfile: {
      ...
      description: 'Choose what you work on. AI for Boss will suggest a small set of installed Skills locally.',
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      forceStopUnavailable: 'Force stop is unavailable for this gateway source.',
      viewLogs: 'View logs',
      ...
      doctorStarted: 'Doctor started.',
      healthHealthy: 'Gateway is healthy.',
      healthUnhealthy: 'Gateway health check failed.',
    ...
    statusbar: {
      ...
      contextUsagePanel: {
        ...
        compactAt: (tokens, percent) => `AI for Boss compacts at ${tokens} (${percent}% of the current route)`,
        compactNow: 'The compact threshold has been reached',
        compactionCount: count => `Compactions: ${count}`,
        costActual: amount => `Provider-reported session cost: ${amount} USD`,
        costDisclaimer: 'Published API estimate; tool, regional, and contract charges may differ.',
        costEstimated: amount => `Estimated session cost: ${amount} USD`,
        costIncluded: 'Included in the current subscription',
        costReference: amount => `API-equivalent value: ${amount} USD — reference only, not billed`,
        costReferenceCompact: amount => `API-equivalent: ${amount} USD · not billed`,
        costTitle: 'Session cost',
        costTokens: (input, output, cache) => `${input} input · ${output} output · ${cache} cached`,
        costUnknown: 'No published price for this route yet',
        conversationContext: tokens => `Conversation context: ${tokens}`,
        effectiveCapacity: (tokens, percent) => `Current route limit: ${tokens} · ${percent}% used`,
        empty: 'No context data yet',
        estimated: 'Estimated',
        loading: 'Loading breakdown…',
        measured: 'Measured',
        modelLabel: model => `Working model: ${model}`,
        logicalHistory: tokens => `Logical history: ${tokens}`,
        percentFull: percent => `${percent}% of published context`,
        publishedCapacity: (tokens, source) => `Published capacity: ${tokens} · ${source}`,
        quotaRemaining: (provider, percent) => `Provider quota (${provider}): ${percent}% remaining`,
        quotaReset: value => `Quota resets: ${value}`,
        quotaUnavailable: 'Provider quota: unavailable',
        remaining: tokens => `Remaining in published window: ${tokens}`,
        sourceAnthropic: 'Anthropic',
        sourceOpenAI: 'OpenAI',
        sourceRuntime: 'Current route',
        systemBackground: tokens => `System + background: ${tokens}`,
        title: 'Context Usage',
        tokenSummary: (used, max) => `${used} / ${max} Tokens`,
        tokensUntilCompact: tokens => `${tokens} until AI for Boss compacts`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. AI for Boss will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'AI for Boss is restarting...',
      askRestart: 'Ask AI for Boss to restart the server',
      lookingRestart: taskId => `AI for Boss is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'AI for Boss is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `AI for Boss finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'AI for Boss could not restart the server.',
      stillWorking:
        'AI for Boss is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
      ...
      connector: {
        openButton: 'Use a Chrome or Edge session',
        title: 'AI for Boss Connector',
        description: 'Transfer cookies for this website from the official Chrome or Edge companion.',
        loading: 'Checking connector…',
        officialExtension: 'Official companion extension',
        trustVerified: 'Bundle digest and permission policy verified.',
        trustFailed: 'The extension bundle failed verification. Keep the connector disabled.',
        openFolder: 'Open folder',
        extensionId: 'Extension ID',
        digest: 'SHA-256',
        enabled: 'Connector enabled',
        disabled: 'Connector disabled',
        enableDescription: 'Enabling permits short-lived loopback pairing. Every website still requires approval.',
        enable: 'Enable',
        disable: 'Disable',
        currentSite: 'AI for Boss Browser website',
        createCode: 'Create one-time code',
        pairingTitle: 'Pair the browser extension',
        pairingInstructions:
          'Open AI for Boss Connector on the same website in Chrome or Edge, preview cookies, then enter this code.',
        copy: 'Copy',
        expiresAt: time => `Expires at ${time}`,
        previewReady: 'Review before importing',
        browser: 'Browser',
        domain: 'Domain',
        cookies: 'Importable cookies',
        sessionCookies: 'Session cookies',
        unsupported: 'Unsupported',
        expiry: 'Latest expiry',
        sessionOnly: 'When the session closes',
        importWarning:
          'Import can replace cookies with the same identity in AI for Boss Browser. Partitioned cookies are skipped.',
        confirmImport: (count, hostname) => `Import ${count} cookies for ${hostname}`,
        importing: 'Waiting securely and importing…',
        imported: (count, hostname) => `Imported ${count} cookies for ${hostname}.`,
        skippedUnsupported: count => `Skipped ${count} unsupported partitioned cookies.`,
        importedSessions: 'Imported website sessions',
        noImports: 'No imported website sessions.',
        importRecord: (count, time) => `${count} cookies · ${time}`,
        revoke: 'Delete',
        revokeWarning:
          'Delete removes only recorded cookie identities. A site-refreshed cookie with the same identity is also removed.',
        error: code => `Connector could not continue (${code}). No cookie value was written to logs.`,
        close: 'Close'
      }
    }
  },
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'AI for Boss is loading a response',
      ...
      workProgress: {
        analyzingAction: 'AI for Boss is framing the request',
        analyzingReason: 'To identify the goal, constraints, and next safe step.',
        reasoningAction: 'AI for Boss is evaluating the next step',
        reasoningReason: 'To choose an action that follows the evidence already available in this session.',
        respondingAction: 'AI for Boss is preparing the response',
        respondingReason: 'To turn the verified work into a clear result for you.',
        compactingAction: 'AI for Boss is summarizing the session',
        compactingReason: 'To preserve the important context before continuing within the model limit.',
        toolPreparingAction: name => `Preparing ${name}`,
        toolPreparingReason: 'To turn the selected step into an executable action.',
        toolRunningAction: name => `Running ${name}`,
        toolRunningReason: 'To gather or verify the evidence needed for the current goal.',
        toolCheckingAction: name => `Checking ${name}`,
        toolCheckingReason: 'To decide whether that step succeeded and what should happen next.',
        advisorPlanAction: 'Advisor is reviewing the plan',
        advisorPlanReason: 'To verify goal alignment, constraints, and authorization before changes run.',
        advisorRecoveryAction: 'Advisor is reviewing the changed approach',
        advisorRecoveryReason: 'To make sure the revised route still serves the original goal.',
        advisorFinalAction: 'Advisor is checking the final result',
        advisorFinalReason: 'To compare the result and its evidence with the original user objective.',
        checkpointPlan: 'the plan',
        checkpointRecovery: 'the changed approach',
        checkpointFinal: 'the final result',
        advisorPassedAction: checkpoint => `Advisor approved ${checkpoint}`,
        advisorPassedReason: 'The checkpoint is aligned with the user objective.',
        advisorRevisionAction: checkpoint => `Advisor requested a revision to ${checkpoint}`,
        advisorRevisionReason: 'AI for Boss will refine the affected step before continuing.',
        advisorUnavailableAction: 'Advisor is unavailable',
        advisorUnavailableReason: 'AI for Boss will follow the configured availability policy for this session.',
        advisorFailedAction: 'Advisor review could not complete',
        advisorFailedReason: 'The main workflow will follow its configured safe fallback.',
        advisorUnresolvedAction: 'Advisor still has unresolved concerns',
        advisorUnresolvedReason: 'AI for Boss will report the remaining gap instead of claiming unsupported completion.'
      }
    },
    approval: {
      gatewayDisconnected: 'AI for Boss gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). AI for Boss won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'AI for Boss needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'AI for Boss needs a credential to continue.',
