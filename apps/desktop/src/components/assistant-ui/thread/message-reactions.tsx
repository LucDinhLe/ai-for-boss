      ...
      >
        {expanded ? (
          ...
          <>
            ...
            <Button
              aria-label={locale === 'vi' ? 'Thêm emoji' : 'More emoji'}
    ...
    >
      {reactions.map(reaction =>
        reaction.author === 'user' && onRetract ? (
          <button
            aria-label={isVi ? `Gỡ cảm xúc ${reaction.emoji}` : `Remove ${reaction.emoji} reaction`}
