...
const AGENT_LOCALES = {
  en: {
    ...
    profile: {
      ...
      unsupportedSessionOpen: 'This AI for Boss version cannot open stored sessions',
    ...
    remote: {
      ...
      updateRequired: 'Update AI for Boss to chat with Agents on other connections.',
  ...
  vi: {
    ...
    profile: {
      ...
      unsupportedSessionOpen: 'Phiên bản AI for Boss này chưa thể mở phiên đã lưu',
    ...
    remote: {
      ...
      updateRequired: 'Hãy cập nhật AI for Boss để trò chuyện với Agents trên kết nối khác.',
